...
!(function (e, t) {
	...
	const t = (e) => {
		...
		L = () => {
			const e = Array.from(
					f().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')
				).sort((e, t) => {
		...
		Se = (t, i) => {
			((e, t) => {
				const n = m(),
					o = f();
				t.toast
					? (_(n, "width", t.width), (o.style.width = "100%"), o.insertBefore(P(), b()))
					: _(o, "width", t.width),
	...
	const wn = (t, n, o) =>
		...
		vn = (e, t) => {
			const n = ((e) => {
					...
					const n = t.content;
					return (
						ln(n), Object.assign(en(n), tn(n), nn(n), on(n), sn(n), rn(n), an(n, Qt))
					);
				})(e),
